            ...
            rpc.query({
                ...
                if(result){
                    ...
                    for(var i=0;i<res.length;i++){
                        dataSet.push([res[i].lead_name, res[i].expected_revenue,res[i].probability,'<span class="label label-success">' + '</span>'])
                    }
                    if(dataSet.length > 0){
    ...
    get_activity_data : function(value){
            ...
            rpc.query({
                ...
                if(result){
                    ...
                    var dataSet = []
                    for(var i=0;i<res.length;i++){
                        dataSet.push([res[i].activity_name.en_US,'<span class="label label-success">' + '</span>'])
                    }
                    if(dataSet.length > 0){
    ...
    get_won_data : function(value){
            ...
            rpc.query({
                ...
                if(result){
                    ...
                    exp_csv.click(function(){        
                        var html = document.getElementById("woncounttable").outerHTML;
                        var csv = [];
    ...
    get_loss_data : function(value){
            ...
            rpc.query({
                ...
                if(result){
                    ...
                    exp_csv.click(function(){        
                        var html = document.getElementById("losscounttable").outerHTML;
                        var csv = [];
